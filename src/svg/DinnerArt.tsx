...
function DinnerArt(props: React.HTMLAttributes<SVGElement>) {
  return (
    <svg width="100%" height="100%" viewBox="0 0 903.77 657.14" {...props}>
      ...
      />
      <path
        d="M926.51 555.06c0 5 9.06 19.52 9.06 19.52s9.06-14.51 9.06-19.52a9.06 9.06 0 00-18.13 0zM911.53 582.79c2.72 4.2 18.22 11.46 18.22 11.46s-.28-17.11-3-21.31a9.06 9.06 0 10-15.21 9.85zM912.18 630.16c4.47 2.25 21.51.7 21.51.7s-8.88-14.63-13.35-16.88a9.06 9.06 0 10-8.16 16.18zM920.75 665.9c4 3 21.08 4.32 21.08 4.32s-6.28-15.92-10.3-18.89a9.06 9.06 0 00-10.78 14.57zM948.77 595.22c-3.59 3.49-20.32 7.1-20.32 7.1s4.1-16.61 7.69-20.1a9.06 9.06 0 0112.63 13zM958.26 637.13c-4.47 2.25-21.51.7-21.51.7s8.88-14.63 13.35-16.83a9.06 9.06 0 018.16 16.18zM961.89 679.14c-4 3-21.08 4.32-21.08 4.32s6.28-15.92 10.3-18.89a9.06 9.06 0 0110.78 14.57z"
        transform="translate(-148.11 -121.43)"
        fill="#6c63ff"
      />
      <path
        d="M63.89 514.69s25.69-87.12-4.8-151.32c-12.8-26.93-17-57.15-11.13-86.37a231.54 231.54 0 0112.23-40.54"
        fill="none"
        stroke="#535461"
        strokeMiterlimit={10}
        strokeWidth={2}
      />
      <path
        d="M189.33 317.34c0 10.68 19.34 41.66 19.34 41.66S228 328 228 317.34a19.34 19.34 0 10-38.68 0zM157.36 376.51c5.81 9 38.88 24.46 38.88 24.46s-.6-36.52-6.41-45.48a19.34 19.34 0 00-32.47 21zM158.75 477.63c9.54 4.81 45.91 1.49 45.91 1.49s-19-31.22-28.49-36a19.34 19.34 0 00-17.42 34.54zM177 553.9c8.59 6.35 45 9.22 45 9.22s-13.4-34-22-40.32a19.34 19.34 0 00-23 31.1zM236.85 403c-7.66 7.44-43.36 15.15-43.36 15.15s8.74-35.46 16.4-42.9a19.34 19.34 0 0127 27.75zM257.1 492.51c-9.54 4.81-45.91 1.49-45.91 1.49s19-31.22 28.49-36a19.34 19.34 0 1117.42 34.54zM264.85 582.17c-8.59 6.35-45 9.22-45 9.22s13.4-34 22-40.32a19.34 19.34 0 0123 31.1zM527.26 421.22L471.53 414c-2.26-.29-4-1.15-3.94-1.9.1-.75 2-1.1 4.31-.77l55.61 8.05c1.53.22 2.69.8 2.62 1.31-.07.48-1.35.73-2.87.53zM527.61 422.17l-55.9-5.78c-2.27-.23-4.2.19-4.27.94-.07.75 1.74 1.54 4 1.74l56 5c1.54.14 2.8-.16 2.85-.67.04-.54-1.15-1.07-2.68-1.23zM611.47 464.22l55.72-7.22c2.26-.29 4-1.15 3.94-1.9-.1-.75-2-1.1-4.31-.77l-55.61 8.05c-1.53.22-2.69.8-2.62 1.31.07.48 1.35.73 2.88.53zM611.11 465.17l55.9-5.78c2.27-.23 4.2.19 4.27.94.07.75-1.74 1.54-4 1.74l-56 5c-1.54.14-2.8-.16-2.85-.67-.04-.54 1.15-1.07 2.68-1.23z"
        transform="translate(-148.11 -121.43)"
        fill="#6c63ff"
      />
      ...
      <path
        d="M415.6 607.19c0 7.22-24.48 13.08-54.68 13.08s-53.49-5.85-53.49-13.08 23.29-13.08 53.49-13.08 54.68 5.89 54.68 13.08z"
        transform="translate(-148.11 -121.43)"
        fill="#f6c6cd"
      />
      <path
      ...
      />
      <path
        d="M782.73 666.55L758 685.12s.11 1.26.18 3.27c9.34-2.56 29.69-9.36 30-20a47.92 47.92 0 00-5.45-1.84z"
        transform="translate(-148.11 -121.43)"
        opacity={0.1}
      />
      <path
      ...
      />
      <path
        d="M750.91 533.06l-10.61 31.83s-59.67 36.69-64.54 41.55c-3.78 3.78-8.84 18.57 8.84 30.94s66.3 51.28 66.3 51.28 37.13-8 34.48-23l-61-44.2s26.52-23 53.93-19.45 31.83-1.77 31.83-1.77 21.22-21.24 14.14-41.54-73.37-25.64-73.37-25.64z"
        transform="translate(-148.11 -121.43)"
        fill="#758ac8"
      />
      <path
      ...
      />
      <path
        d="M306.86 553.68s-12 41 24 48l39-2s55-11 70-3c0 0 6 1 4 9s3 62 3 62v18s34 0 38-4c0 0-3-16 0-29s-5-54-5-54l-.79-24.68a17.16 17.16 0 00-9.06-14.8 13.4 13.4 0 00-6.14-1.56s-68-11-92-9-65.01 5.04-65.01 5.04z"
        transform="translate(-148.11 -121.43)"
        opacity={0.1}
      />
      <path
        d="M306.86 552.68s-12 41 24 48l39-2s55-11 70-3c0 0 6 1 4 9s3 62 3 62v18s34 0 38-4c0 0-3-16 0-29s-5-54-5-54l-.79-24.68a17.16 17.16 0 00-9.06-14.8 13.4 13.4 0 00-6.14-1.56s-68-11-92-9-65.01 5.04-65.01 5.04z"
        transform="translate(-148.11 -121.43)"
        fill="#8b9cd1"
      />
      <path
      ...
      />
      <path
        d="M385.86 397.68s-9 29-9 40-38-3-37-9 22-28 23-37 23 6 23 6z"
        transform="translate(-148.11 -121.43)"
        fill="#f8bdc5"
      />
      <path
        d="M355.86 417.68s-35-9-40 42 4 57-11 88 102 4 102 4-6-7-25-4l-9-27s-3-12 14-12 9-35 9-35-9-30-14-33-14-21-26-23z"
        transform="translate(-148.11 -121.43)"
        opacity={0.1}
      />
      <path
        d="M355.86 415.68s-35-9-40 42 4 57-11 88 102 4 102 4-6-7-25-4l-9-27s-3-12 14-12 9-35 9-35-9-30-14-33-14-21-26-23z"
        transform="translate(-148.11 -121.43)"
        fill="#eb6475"
      />
      <path
      ...
      <g opacity={0.1} fill="#fff">
        <path
          d="M475.72 678.56a34.56 34.56 0 011.14-7.88l-.5.17a34.82 34.82 0 00-.64 7.71zM480.86 715.68c-8 .47-33-11-38-17a5.33 5.33 0 01-1.16-2.84 6.28 6.28 0 001.16 4.84c5 6 30 17.47 38 17 8.5-.5 37 1 38-12a1.62 1.62 0 00-.14-1.06c-2.29 11.98-29.57 10.57-37.86 11.06z"
          transform="translate(-148.11 -121.43)"
        />
      </g>
      <path
        ...
        strokeMiterlimit={10}
        strokeWidth={0.25}
        d="M372.25 295.75H373.25V336.75H372.25z"
      />
      <path
        fill="#ffd77c"
        stroke="#ffab50"
        strokeMiterlimit={10}
        strokeWidth={0.25}
        d="M373.25 295.75H374.25V336.75H373.25z"
      />
      <path
        fill="#ffd77c"
        stroke="#ffab50"
        strokeMiterlimit={10}
        strokeWidth={0.25}
        d="M374.25 295.75H375.25V336.75H374.25z"
      />
      <path
        fill="#ffd77c"
        stroke="#ffab50"
        strokeMiterlimit={10}
        strokeWidth={0.25}
        d="M375.25 295.75H376.25V336.75H375.25z"
      />
      <path
        fill="#ffd77c"
        stroke="#ffab50"
        strokeMiterlimit={10}
        strokeWidth={0.25}
        d="M376.25 295.75H377.25V336.75H376.25z"
      />
      <path
        fill="#ffd77c"
        stroke="#ffab50"
        strokeMiterlimit={10}
        strokeWidth={0.25}
        d="M377.25 295.75H378.25V336.75H377.25z"
      />
      <path
        fill="#ffd77c"
        stroke="#ffab50"
        strokeMiterlimit={10}
        strokeWidth={0.25}
        d="M378.25 295.75H379.25V336.75H378.25z"
      />
    </svg>
  );
}

export default DinnerArt;
